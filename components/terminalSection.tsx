        ...
        switch (e) {
          case '\r': {
            ...
            if (command === '') {
              ...
              term.current.writeln('');
              term.current.writeln('\x1b[1;36m[1]\x1b[0m \x1b[1mConnectUs\x1b[0m');
              term.current.writeln('    \x1b[90mJul 2025 – Nov 2025\x1b[0m');
              term.current.writeln('    Real-time messaging app with Flutter, GraphQL, Supabase & WebSockets');
              term.current.writeln('    \x1b[36mhttps://github.com/ojaswi1234/ConnectUs.git\x1b[0m');
              term.current.writeln('');
              term.current.writeln('\x1b[1;36m[2]\x1b[0m \x1b[1mDevOps Dashboard\x1b[0m');
              term.current.writeln('    \x1b[90mMar 2025 – May 2025\x1b[0m');
              term.current.writeln('    Containerized multi-tenant Node.js app with real-time health monitoring');
              term.current.writeln('    Live: \x1b[36mhttps://devops-project-quzm.onrender.com/\x1b[0m');
              term.current.writeln('    GitHub: \x1b[36mhttps://github.com/ojaswi1234/devops_project.git\x1b[0m');
              term.current.writeln('');
              term.current.writeln('\x1b[1;36m[3]\x1b[0m \x1b[1mJust Notes\x1b[0m');
              term.current.writeln('    \x1b[90mAug 2024 – Nov 2024\x1b[0m');
              term.current.writeln('    Browser extension for quick note-taking & live webpage annotation');
              term.current.writeln('    Edge Add-on: \x1b[36mhttps://microsoftedge.microsoft.com/addons/detail/just-notes/mddmihmmmhkmllhcdjhlfhnpgjngdild\x1b[0m');
              term.current.writeln('    GitHub: \x1b[36mhttps://github.com/ojaswi1234/notes_maker_ext.git\x1b[0m');
              term.current.writeln('');
              term.current.writeln('\x1b[1;36m[4]\x1b[0m \x1b[1mSleepSense\x1b[0m');
              ...
              term.current.writeln('');
              term.current.writeln('\x1b[1;36m[5]\x1b[0m \x1b[1m2 Player Chess Game\x1b[0m');
              ...
              term.current.writeln('');
              term.current.writeln('\x1b[1;36m[6]\x1b[0m \x1b[1mMovie Spot\x1b[0m');
